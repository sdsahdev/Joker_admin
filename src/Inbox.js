      ...
      <View style={{position: 'relative'}}>
        <ScrollView>
          ...
          <SearchBar
            ...
            onChangeSearchText={handleSerach}
            press={() => handlemodal()}
            filter={true}
          />

          <View
            style={{marginRight: wp(9), width: '100%', marginBottom: hp(12)}}>
            <FlatList
            ...
            />
            <Modal visible={Visible} transparent={true} mationType="slide">
              <TouchableWithoutFeedback onPress={() => setVisible(false)}>
                <View style={styles.modalContent}>
                  <View
                    ...
                    <TouchableOpacity
                      style={styles.mbtn}
                      onPress={() => filterData('booked')}>
                      <Text style={{color: '#fff'}}>Booked</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={styles.mbtn}
                      onPress={() => filterData('cancel_request')}>
                      <Text style={{color: '#fff'}}>Cancel Booking</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={styles.mbtn}
                      onPress={() => filterData('cancelled')}>
