    ...
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.navigate('Details', {item})}>
        <View style={{flexDirection: 'row'}}>
          ...
          <FastImage
            source={
              item.images[0] ? {uri: item.images[0].url} : imagesClass.box4
            }
            style={[
              item.images[1]
                ? [styles.image]
                : [item.images[1], {width: '100%', height: '100%'}],
            ]}
            resizeMode="stretch"
          />
          <FastImage
            source={
              item.images[1] ? {uri: item.images[1].url} : imagesClass.box4
            }
            style={styles.image2}
            resizeMode="stretch"
          />
